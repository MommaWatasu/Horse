...
pub fn setup_qemu_card(dev: &Device) {
    ...
    unsafe {
        ...
        bga_write_register(mmio_base, BGARegisters::VBE_DISPI_INDEX_XRES as u32, max_res.0);
        bga_write_register(mmio_base, BGARegisters::VBE_DISPI_INDEX_YRES as u32, max_res.1);
